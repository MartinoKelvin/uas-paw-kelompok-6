...
const DEFAULT_TITLE = "Wanderlust Inn";
const DEFAULT_DESCRIPTION =
  "Book your dream vacation with Wanderlust Inn. Explore amazing travel packages to destinations worldwide with expert travel agents.";
