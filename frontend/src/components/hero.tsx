        ...
        <FadeUpOnScroll>
          <header className="border-border border-b pb-6 md:pb-8">
            <div className="flex flex-col gap-6 md:flex-row md:items-center md:justify-between">
              <h1 className="text-foreground text-lg font-bold md:text-2xl lg:text-5xl">
                Team Collaboration
              </h1>
              <p className="text-muted-foreground max-w-3xl text-sm font-medium leading-relaxed md:text-lg lg:text-base">
