...
export default function PackagesPage() {
  ...
  const [selectedDestination, setSelectedDestination] = useState<string>(
    getParam("destination", "all")
  );
  const [priceRange, setPriceRange] = useState<string>(getParam("price", "all"));
  const [sortBy, setSortBy] = useState<string>(getParam("sort", "popular"));
  ...
  useSEO({
    ...
    description:
      "Explore our collection of amazing travel packages to destinations worldwide. Find your perfect vacation with Wanderlust Inn.",
    keywords:
