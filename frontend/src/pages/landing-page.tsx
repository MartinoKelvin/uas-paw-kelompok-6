...
export default function LandingPage() {
  ...
  useSEO({
    title: "Home",
    description:
      "Discover amazing travel packages and book your dream vacation with Wanderlust Inn. Explore destinations worldwide with expert travel agents.",
    keywords:
      "travel packages, vacation booking, holiday destinations, tourism, travel agent, wanderlust inn",
    ogImage: heroImage,
  });
