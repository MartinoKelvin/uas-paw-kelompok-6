...
export default function AboutPage() {
  ...
  useSEO({
    title: "About Us",
    description:
      "Learn about Wanderlust Inn, your trusted travel partner. We are passionate about creating unforgettable travel experiences and authentic adventures.",
    keywords:
      "about wanderlust inn, travel company, travel agency, tourism company, vacation planning",
  });
          ...
          <div className="grid gap-8 md:grid-cols-2 md:items-center">
            <div className="space-y-6">
              ...
              <div className="text-muted-foreground space-y-4 text-sm leading-relaxed md:text-base">
                <p>
                  Founded in 2020, Wanderlust Inn was born from a simple idea: travel should be
                  accessible, memorable, and transformative for everyone.
                </p>
                <p>
                  What started as a small team of passionate travelers has grown into a leading
                  travel booking platform, connecting thousands of travelers with their dream
